...
local function make_treasure_rooms(dungeon_maps, materials, room_styles, dungeon_pos, dungeon_deph, treasure_block)
    local i = #dungeon_maps
    local level_pos = {x=dungeon_pos.x, y=dungeon_pos.y-((i-1)*dungeon_deph), z=dungeon_pos.z}
